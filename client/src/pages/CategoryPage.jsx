...
const CategoryPage = () => {
    ...
    const [opneConfirmBoxDelete, setOpenConfirmBoxDelete] = useState(false)
    ...
    return (
        <section>
            <div className='p-2 bg-white shadow-md flex items-center justify-between'>
                ...
                <button onClick={() => setOpenUploadCategory(true)} className='text-sm border border-primary-200 hover:bg-primary-200 rounded px-3 py-1'>Add Category</button>
            </div>
            ...
            <div className='p-4 grid grid-cols-2  lg:grid-cols-6 md:grid-cols-4 gap-2'>
                {
