  ...
  return (
    <div className='p-3 bg-white rounded'>
        ...
        <div className='grid grid-cols-2 gap-3 py-2'>
          <button onClick={()=>setEditOpen(true)} className='border px-1 py-1 text-xs lg:text-sm border-green-600 bg-green-100 text-green-800 hover:bg-green-200 rounded'>Edit</button>
          <button onClick={()=>setOpenDelete(true)} className='border px-1 py-1 text-xs lg:text-sm border-red-600 bg-red-100 text-red-600 hover:bg-red-200 rounded'>Delete</button>
        </div>
        {
          editOpen && (
        ...
        {
          openDelete && (
            <section className='fixed top-0 bottom-0 right-0 left-0 bg-neutral-600  z-50 bg-opacity-70 p-4 flex items-center justify-center '>
