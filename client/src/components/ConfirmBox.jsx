...
const ConfirmBox = ({ close, confirm, cancel }) => {
    return (
        <div className='fixed top-0 bottom-0 left-0 right-0 bg-neutral-800 bg-opacity-70 p-4 flex justify-center items-center z-50'>
            <div className='bg-white w-full max-w-md p-4 rounded  '>
                <div className='flex justify-between items-center pag-3'>
